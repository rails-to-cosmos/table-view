...
instance SP.ManagedPtrNewtype DeviceInfoPermissionRequest where
    toManagedPtr (DeviceInfoPermissionRequest p) = p
...
instance B.Types.TypedObject DeviceInfoPermissionRequest where
    glibType = c_webkit_device_info_permission_request_get_type

instance B.Types.GObject DeviceInfoPermissionRequest

-- | Type class for types which can be safely cast to t'DeviceInfoPermissionRequest', for instance with `toDeviceInfoPermissionRequest`.
...
-- | Cast to t'DeviceInfoPermissionRequest', for types for which this is known to be safe. For general casts, use 'Data.GI.Base.ManagedPtr.castTo'.
toDeviceInfoPermissionRequest :: (MIO.MonadIO m, IsDeviceInfoPermissionRequest o) => o -> m DeviceInfoPermissionRequest
toDeviceInfoPermissionRequest = MIO.liftIO . B.ManagedPtr.unsafeCastTo DeviceInfoPermissionRequest

-- | Convert t'DeviceInfoPermissionRequest' to and from t'Data.GI.Base.GValue.GValue'. See 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue (Maybe DeviceInfoPermissionRequest) where
    gvalueGType_ = c_webkit_device_info_permission_request_get_type
    gvalueSet_ gv P.Nothing = B.GValue.set_object gv (FP.nullPtr :: FP.Ptr DeviceInfoPermissionRequest)
    gvalueSet_ gv (P.Just obj) = B.ManagedPtr.withManagedPtr obj (B.GValue.set_object gv)
    gvalueGet_ gv = do
        ptr <- B.GValue.get_object gv :: IO (FP.Ptr DeviceInfoPermissionRequest)
        if ptr /= FP.nullPtr
        then P.Just <$> B.ManagedPtr.newObject DeviceInfoPermissionRequest ptr
        else return P.Nothing
        
    

#if defined(ENABLE_OVERLOADING)
type family ResolveDeviceInfoPermissionRequestMethod (t :: Symbol) (o :: DK.Type) :: DK.Type where
...
type DeviceInfoPermissionRequestAttributeList = ('[ ] :: [(Symbol, DK.Type)])
#endif
...
type DeviceInfoPermissionRequestSignalList = ('[ '("notify", GObject.Object.ObjectNotifySignalInfo)] :: [(Symbol, DK.Type)])
